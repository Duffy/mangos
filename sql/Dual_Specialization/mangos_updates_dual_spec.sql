REPLACE INTO gossip_menu_option
...
VALUES
   (0, 16, 16, 'Purchase a Dual Talent Specialization.', 19, 16, 0, 0, 0, 0, 10000000, 'Are you sure you wish to purchase a Dual Talent Specialization?', 0, 0, 0, 0, 0, 0, 0, 0, 0);
